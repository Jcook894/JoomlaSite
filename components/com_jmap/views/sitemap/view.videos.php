...
class JMapViewSitemap extends JMapView {
	...
	function display($tpl = null) {
		...
		$this->outputtedVideosBuffer = JRequest::getVar('process_status', null) === 'run' ? $session->get('com_jmap.videos_buffer') : array();
		...
		if(in_array(JRequest::getVar('process_status', null), array('start', 'run'))) {
		...
		if(JRequest::getVar('process_status', null) === 'end') {
