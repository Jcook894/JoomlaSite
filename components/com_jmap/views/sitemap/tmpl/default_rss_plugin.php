...
<link><?php echo str_replace(' ', '%20', $this->liveSite . $elm->link ); ?></link>
...
<pubDate><?php $dateObj = new JDate($elm->publish_up); $dateObj->setOffset($this->globalConfig->get('offset'));echo $dateObj->toRFC822(true);?></pubDate>
</item>
<?php
	}
}