...
<?php endif; ?>
<news:publication_date><?php $dateObj = new JDate($item->publish_up); $dateObj->setOffset($this->globalConfig->get('offset'));echo $dateObj->toISO8601(true);?></news:publication_date>
