...
class WidgetsHelper extends MyHelper
{
    ...
    function claim($listing)
    {
        ...
        {
            return '<span id="jr_claimImg'.$listing_id.'" class="jrButton jr_claimListing" title="'.__t("Claim This Business", true).'" onclick="jreviews.listing.claim(this,{title:\''. __t("Claim This Business",true,true).'\',listing_id:'.$listing_id.'}); return false;">'. __t("Claim This Business", true).'</span>';        
        }                                                     
