 ...
 **********************************************************************************/
     ...
     {
        $assets = array(
            'js'=>array('jquery','jq.ui.core','jreviews','jreviews.compare','jq.scrollable','jq.tooltip'),
 ...
 **********************************************************************************/
    ...
    {
        $assets = array(
            'js'=>array('jquery','jq.ui.core','jreviews','jreviews.compare','jq.jreviews.plugins','jq.fancybox','jq.scrollable'),
 ...
 **********************************************************************************/
     function CommunityListings()
     {
        ...
        $page_count > 1 and $assets['js'] = array('jquery'=>'jquery','jreviews','jq.scrollable');
 ...
 **********************************************************************************/
     ...
     {
        $assets = array(
            'js'=>array('jquery','jq.ui.core','jreviews','jq.jreviews.plugins','jq.tooltip'),
 ...
 **********************************************************************************/
    function EverywhereIndex()
    {
        ...
        $assets = array(
            'js'=>array('jquery'=>'jquery','jq.ui.core','jreviews','jq.jreviews.plugins'),
            'css'=>array('theme','theme.detail','theme.form','jq.ui.core','paginator')
        );

        if($extension == 'com_community_access') {
            $assets['css'][] = 'plugins';
        }
 ...
 **********************************************************************************/
    ...
    {
        $assets = array(
            'js'=>array('jquery','jq.ui.core','jreviews','jreviews.fields','jq.ui.rating','jq.tooltip','jq.jreviews.plugins'),
...
//            $this->Editor->transform();
    ...
    {
        $assets = array(
            'js'=>array('jquery','jq.ui.core','jreviews','jreviews.compare','jreviews.fields','jq.ui.rating','jq.jreviews.plugins','jq.tooltip'),
 ...
 **********************************************************************************/
    function ModuleAdvancedSearch()
    {
        ...
        $assets = array(
             'js'=>array('jquery','jq.ui.core','jreviews','jreviews.fields'),
 ...
 **********************************************************************************/
    ...
    {
        $assets = array(
            'js'=>array('jquery','jq.ui.core','jreviews','jq.jreviews.plugins'),
            'css'=>array('theme','theme.detail','theme.form','jq.ui.core','paginator')
        );
 ...
 **********************************************************************************/
    ...
    {
        $assets = array(
            'js'=>array('jquery','jq.ui.core','jreviews','jreviews.fields','jq.tooltip','jq.jreviews.plugins'),
            'css'=>array('theme','theme.form','jq.ui.core')
        );
