...
class LibrariesHelper extends MyHelper
{
	function js()
	{
        ...
        $javascriptLibs['jquery']               =   'jquery/jquery-1.8.2.min';
        $javascriptLibs['jq.ui.core']           =   'jquery/jquery-ui-1.8.24.custom.min';
//        $javascriptLibs['jq.ui.accordion']      =   'jquery/ui.accordion.min';
	...
	function css()
	{
        ...
        $styleSheets['jq.ui.core']              =   'jquery_ui_theme/jquery-ui-1.8.24.custom';
