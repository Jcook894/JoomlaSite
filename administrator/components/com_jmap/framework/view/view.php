...
JS;
	...
	protected function loadBootstrap(&$document) {
		$document->addStylesheet ( JURI::root ( true ) . '/administrator/components/com_jmap/css/bootstrap.css' );
		...
		$document->addScript ( JURI::root ( true ) . '/administrator/components/com_jmap/js/bootstrap.js' );
