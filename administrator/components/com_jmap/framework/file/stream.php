<?php
// namespace components\com_jmap\libraries\file;
/**
 ...
 * @since 2.3
 */
class JMapFileStream extends JObject {
	/**
	 * File Mode
	 *
	 * @var integer
	 ...
	 * @param boolean $detectprocessingmode
	 ...
	 *        	The key name of the filter.
	 * @param integer $read_write
	 *        	Optional. Defaults to STREAM_FILTER_READ.
	 * @param array $params
	 ...
	 *
	 * @param string $src
	 *        	The file path to move from.
	 * @param string $dest
	 *        	The file path to move to.
	 * @param resource $context
	 *        	A valid context resource (optional) created with stream_context_create.
	 * @param boolean $use_prefix
	 *        	Controls the use of a prefix (optional).
	 ...
	 *
	 * @param string $src
	 *        	The file path to copy from (usually a temp folder).
	 * @param string $dest
	 *        	The file path to copy to.
	 * @param resource $context
	 *        	A valid context resource (optional) created with stream_context_create.
