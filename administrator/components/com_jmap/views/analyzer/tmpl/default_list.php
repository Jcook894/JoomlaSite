...
<form action="index.php" method="post" name="adminForm" id="adminForm">
	<table class="headerlist">
		<tr>
			...
			<td nowrap="nowrap">
				<label class="btn btn-primary btn-xs"><?php echo JText::_('COM_JMAP_FILTER' ); ?></label>
		...
		if(isset($row->httpstatus)) {
			...
			switch ((int)$row->httpstatus) {
				...
				default:
					...
					$valid = JHtml::image('admin/tick.png', $statusAlt, 'class="hasTooltip" title="' . $statusAlt . '"', true);
					$linkValidation = true;
				break;
			}
		} else {
