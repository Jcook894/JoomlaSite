...
<div id="accordion_datasource_sqlquery_querystring" class="sqlquerier panel panel-info panel-group">
	...
	<div class="panel-body  panel-collapse collapse" id="datasource_sqlquery_querystring">
		<table class="admintable">
			...
			<tr>
				<td class="paramlist_key left_title">
					<span class="editlinktip"><label id="paramsguess_sef_itemid-lbl" for="paramsguess_sef_itemid" class="hasPopover" data-content="<?php echo JText::_('COM_JMAP_GUESS_SEF_ITEMID_DESC');?>"><?php echo JText::_('COM_JMAP_GUESS_SEF_ITEMID');?></label></span>
				</td>
				<td class="paramlist_value">
					<div class="controls">
						<?php echo JHTML::_('select.booleanlist', 'params[guess_sef_itemid]', null,  $this->record->params->get('guess_sef_itemid', 0));?>
					</div>
				</td>
			</tr>
			<?php endif; ?>
	...
	<div class="panel-body panel-collapse collapse" id="datasource_sqlquery">
				...
				<table class="admintable">
					...
					<tr>
						...
						<td class="right_details">
							...
							<span class="controls"><?php echo JHTML::_('select.booleanlist', 'sqlquery_managed[use_alias]', null, $this->registrySqlQueryManaged->get('use_alias', 0));?></span>
							<label class="as label label-primary filter"><?php echo JText::_('COM_JMAP_URL_FILTER');?></label>
							<span class="controls"><?php echo JHTML::_('select.booleanlist', 'sqlquery_managed[url_filter_id]', null, $this->registrySqlQueryManaged->get('url_filter_id', 0));?></span>
						</td>
					</tr> 
					...
					<tr>
						...
						<td class="right_details">
							...
							<label class="as label label-primary"><?php echo JText::_('COM_JMAP_SQLQUERY_USEALIAS');?></label>
							<span class="controls"><?php echo JHTML::_('select.booleanlist', 'sqlquery_managed[use_catalias]', null, $this->registrySqlQueryManaged->get('use_catalias', 0));?></span>
							<label class="as label label-primary filter"><?php echo JText::_('COM_JMAP_URL_FILTER');?></label>
							<span class="controls"><?php echo JHTML::_('select.booleanlist', 'sqlquery_managed[url_filter_catid]', null, $this->registrySqlQueryManaged->get('url_filter_catid', 0));?></span>
						</td>
					</tr> 
		...
		<div id="accordion_datasource_sqlquery_jointable<?php echo $jt;?>" class="panel panel-warning panel-group">
			...
			<div class="panel-body panel-collapse collapse" id="datasource_sqlquery_jointable<?php echo $jt;?>">
				<span data-role="jointable_resetter" class="hasPopover glyphicon glyphicon-remove-circle jointable_resetter" data-content="<?php echo JText::_('COM_JMAP_RESET_JOINTABLE_SETTINGS');?>"></span> 
				<table class="admintable">
					<tr>
						<td class="key left_title">
					...
					<tr>
						...
						<td class="right_details">
							...
							<span class="controls"><?php echo JHTML::_('select.booleanlist', 'sqlquery_managed[use_category_title_jointable' . $jt . ']', null, $this->registrySqlQueryManaged->get('use_category_title_jointable'.$jt, 0));?></span>
						</td>
					</tr> 
