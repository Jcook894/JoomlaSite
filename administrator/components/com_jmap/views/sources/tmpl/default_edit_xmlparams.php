		...
		<table  class="admintable">
			<tr>
				...
				<td class="paramlist_value">
					<div class="controls">
						<?php echo JHTML::_('select.booleanlist', 'params[xmlinclude]', null,  $this->record->params->get('xmlinclude', 1));?>
					</div>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="paramlist_value">
					<div class="controls">
						<?php echo JHTML::_('select.booleanlist', 'params[xmlmobileinclude]', null,  $this->record->params->get('xmlmobileinclude', 1));?>
					</div>
				</td>
			</tr>
			<tr>
				...
				<td class="paramlist_value">
					<div class="controls">
						<?php echo JHTML::_('select.booleanlist', 'params[xmlimagesinclude]', null,  $this->record->params->get('xmlimagesinclude', 1));?>
					</div>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="paramlist_value">
					<div class="controls">
						...
						echo JHTML::_('select.radiolist',  $arr, 'params[imagetitle_processor]', '', 'value', 'text', $this->record->params->get('imagetitle_processor', ''));
						?>
					</div>
				</td>
			</tr>
			...
			<?php if(in_array($this->record->type, array('menu'))):?>
			<tr>
