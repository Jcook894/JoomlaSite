...
$doc->addStyleDeclaration('span[data-bind=jmap_version]{background-color: #3a87ad;color: #FFF;width: 25px;border-radius: 3px;padding: 2px;margin: auto;}i.icon-checkmark{width:32px;height:32px;display:block;padding:10px 0;margin:0 auto;background:url('.JUri::base().'components/com_jmap/images/icon-32-apply.png) 0 10px no-repeat}i.icon-cancel{width:32px;height:32px;display:block;padding:10px 0;margin:0 auto;background:url('.JUri::base().'components/com_jmap/images/icon-32-cancel.png) 0 10px no-repeat}')
?>
	<div id="cpanel">
		<div class="icon-wrapper" style="float:left;">
			<div class="icon">
				<a href="<?php echo JRoute::_('index.php?option=com_jmap'); ?>">
					<img style="width:48px; height:48px;" alt="" src="<?php echo JUri::base() . 'components/com_jmap/images/jmap-48x48.png'?>" />
					<span><?php echo JText::_('COM_JMAP_CPANEL');?></span>
				</a>
			</div>
			<div class="icon">
				<a href="<?php echo JRoute::_('index.php?option=com_jmap&task=config.display'); ?>">
					<img style="width:48px; height:48px;" alt="" src="<?php echo JUri::base() . 'components/com_jmap/images/icon-48-config.png'?>" />
					<span><?php echo JText::_('COM_JMAP_CONFIG');?></span>
				</a>
			</div>
			<div class="icon">
